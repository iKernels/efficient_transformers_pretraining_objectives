...
if __name__ == "__main__":
    ...
    parser = ArgumentParser("Creating dataset with `process-datasets`")
    parser.add_argument(
        '--loader', type=str, required=True, choices=ALL_LOADERS, help="Loader class to load data"
    )
    parser.add_argument(
        '--strategy', type=str, required=True, choices=ALL_STRATEGIES, help="Strategy to use to create the dataset"
    )
